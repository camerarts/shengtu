    ...
    <div className="w-20 lg:w-64 flex-none flex flex-col bg-black/20 border-r border-white/10 backdrop-blur-xl h-full pt-6">
      ...
      <div className="p-3 border-t border-white/5 mt-auto">
        <button 
            ...
            className="w-full flex items-center gap-3 px-3 lg:px-4 py-3 rounded-xl text-white/50 hover:text-white hover:bg-white/5 transition-all duration-300 group"
        >
            <div className="text-current group-hover:text-indigo-300 transition-colors">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span className="hidden lg:block text-sm font-medium">设置</span>
        </button>
        <div className="hidden lg:block text-[10px] text-white/20 text-center font-mono mt-2 pb-2">
           Gemini 3 Pro System
        </div>
      </div>
    </div>
