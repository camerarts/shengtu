         ...
         <GlassCard className="h-full flex flex-col justify-center relative overflow-hidden p-0">
            ...
            {!currentResult ? (
                ...
                <div className="relative w-full h-full bg-black/40 flex items-center justify-center group">
                    ...
                    {/* Floating Toolbar */}
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-black/70 backdrop-blur-xl border border-white/10 rounded-2xl p-2 flex items-center gap-2 shadow-2xl opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0">
                         <div className="px-3 text-xs font-mono text-white/60 border-r border-white/10">
